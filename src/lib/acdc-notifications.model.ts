export enum AcdcNotificationLevel {
  ...
  export interface AcdcToastNotifcationLevelConfig{
    titleColor?: string;
    messageColor?: string;
  ...
  export interface AcdcToastsDefaultConfig{
    ...
    iconsColor?: string;
    addToTop?: boolean;
    minCntToShowDeleteAllBtn?: number;
    deleteAllBtnBackgroundColor?: string;
    deleteAllBtnIconColor?: string;
    width?: string;
  ...
  export class AcdcNotifcationsDefaultConfig{
    ...
    constructor(toast: AcdcToastsDefaultConfig) {
      this.toast = toast;
    }
  }
